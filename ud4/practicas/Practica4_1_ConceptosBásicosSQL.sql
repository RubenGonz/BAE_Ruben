--1. Crear una base de datos llamada jardineria

CREATE DATABASE jardineria;

--2. Activar la base de datos jardineria como la base de datos a usar por defecto en la sesión.
use jardineria;

--3. Cargar las tablas y los datos ejecutanto el script de carga siguiente:source F:/jardineria.sql
...
--Mostrar el nombre y el teléfono de los clientes.
